...
class DirectPaymentViewModelTest {
    @get:Rule
    var mainDispatcherRule = MainDispatcherRule()

    private lateinit var viewModel: DirectPaymentViewModel
    private lateinit var directPayment: DirectPayment
    private lateinit var directCancelPayment: DirectCancelPayment
    ...
    @Before
    fun setup() {
        directPayment = mockk<DirectPayment>()
        directCancelPayment = mockk<DirectCancelPayment>()
    ...
    fun `directPayment success emits completePaymentInfo result`() = runTest {
        ...
        val useCaseResult = apiResult.toUseCaseResult {
            it.toCompletePaymentInfo(TransactionType.DIRECT)
        }
