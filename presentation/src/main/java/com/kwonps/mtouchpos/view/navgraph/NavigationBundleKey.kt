...
class NavigationBundleKey {
    companion object {
        const val PAYMENT_DEVICE_INFO = "PaymentDeviceInfo"
        const val DIALOG_DATA = "dialogData"
        const val reDirectPage = "reDirectPage"
        const val MESSAGE = "message"
        const val ITEM_LIST = "itemList"
        const val RESULT_PROCESS = "resultProcess"
        const val RESULT_DATA = "resultData"
        const val BEFORE_NAVGRAPH = "before_navgraph"
