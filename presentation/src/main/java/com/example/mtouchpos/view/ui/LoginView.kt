...
fun PgIdLoginDialog(
    ...
    val loginInfo = mainActivityViewModel.loginInfo.collectAsStateWithLifecycle().value
    ...
    Dialog(
        ...
        Surface(
            ...
            Column(
                ...
                mainActivityViewModel.loginInfo.run {
                    listOf(
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = { mainActivityViewModel.updateUserInfo(textFieldInfo.edit(it)) },
                ...
                GradientButton(
                    ...
                    modifier = Modifier
                        .width((screenWidth * 0.7).dp)
                        .padding(top = 12.dp),
                    onClick = { mainActivityViewModel.login() },
                    fontSize = 16.sp
                )
            }
        }
...
fun RegisteredIdDialog(
    ...
    mainActivityViewModel.fetchUserInfoList()
    mainActivityViewModel.reactLogin
        .collectAsStateWithLifecycle(UseCaseResult.Init).value
        .observeResultLogin(
            navController = navController,
                ...
                LazyColumn(
                    ...
                    item {
                        mainActivityViewModel.run {
                            loginInfoList.collectAsStateWithLifecycle().value
